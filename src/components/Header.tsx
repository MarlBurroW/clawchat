  ...
  return (
    ...
    <header className="h-14 border-b border-pc-border bg-[var(--pc-bg-surface)]/90 backdrop-blur-xl flex items-center px-4 gap-3 shrink-0" role="banner">
      ...
      <div className="flex items-center gap-3 flex-1 min-w-0">
        <div className="flex h-9 w-9 items-center justify-center rounded-2xl border border-pc-border bg-pc-elevated/40">
          <Bot className="h-5 w-5 text-pc-accent-light" />
        </div>
